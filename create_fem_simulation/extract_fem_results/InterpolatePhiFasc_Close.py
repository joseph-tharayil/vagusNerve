...
try:
	...
	simulation = document.AllSimulations["LF Unstructured_Mid"]
	...
	for i in range(39):
		...
		model_to_grid_filter.Name = "Fascicles "+str(i)+"_Spline_0_Random0"
		model_to_grid_filter.Entity = model.AllEntities()["Fascicles "+str(i)+"_Spline_0_Random0"]
		...
		excel_exporter.FileName = u"C:\\Users\\tharayil\\Desktop\\SimResults\\FasciclePhiPeriFixedMid\\"+str(i)+"_BetterConductivity.xlsx"
