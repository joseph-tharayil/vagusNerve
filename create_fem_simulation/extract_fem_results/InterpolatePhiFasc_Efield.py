...
try:
	...
	simulation = document.AllSimulations["StimAll"]
	...
	for i in range(39):
		...
		inputs = [em_sensor_extractor.Outputs["EM E(x,y,z,f0)"], model_to_grid_filter.Outputs["Line"]]
		...
		excel_exporter.FileName = u"C:\\Users\\tharayil\\Desktop\\SimResults\\EfieldBigMesh\\"+str(i)+"_BetterConductivity.xlsx"
