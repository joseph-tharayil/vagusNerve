...
def Recruitment(current,diameters, fascIdx):
    ...
    titrationFactorsMeff = sortTitrationSpace(pd.read_excel('/gpfs/bbp.cscs.ch/project/proj85/scratch/vagusNerve/Data/TitrationGoodConductivity_Standoff_HighConductivity.xlsx',index_col=0)).iloc[-1].values
    ####
...
def FitPhiShape(fascIdx,distance):
    ...
    phi = pd.read_excel('/gpfs/bbp.cscs.ch/project/proj85/scratch/vagusNerve/Data/PhiConductivity/'+str(fascIdx)+'_BetterConductivity.xlsx')
