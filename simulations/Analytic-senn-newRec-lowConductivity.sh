...
filename='/gpfs/bbp.cscs.ch/project/proj85/scratch/vagusNerve/Analytic_allActive_squareTerm_senn_newRec_lowConductivity'
...
srun -n 39 python analytic-Standoff-sideways-lowConductivity-senn-newRec.py $filename $SLURM_ARRAY_TASK_ID
wait
