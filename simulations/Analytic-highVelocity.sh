...
filename='/gpfs/bbp.cscs.ch/project/proj85/scratch/vagusNerve/results/finalResults/Analytic-highVelocity'
...
srun -n 39 python analytic-Standoff-sideways-highConductivity-highVelocity.py $filename $SLURM_ARRAY_TASK_ID
wait
