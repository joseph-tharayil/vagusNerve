...
filename='/gpfs/bbp.cscs.ch/project/proj85/scratch/vagusNerve/Analytic_allActive_squareTerm_senn_gaussian_large'
...
srun -n 39 python analytic-Standoff-sideways-highConductivity-senn-gaussian.py $filename $SLURM_ARRAY_TASK_ID
wait
