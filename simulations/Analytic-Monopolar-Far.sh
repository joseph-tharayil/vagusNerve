...
filename='/gpfs/bbp.cscs.ch/project/proj85/scratch/vagusNerve/results/finalResults/Analytic_monopolar_far'
...
srun -n 39 python analytic-Standoff-sideways-highConductivity-monopolar-far.py $filename $SLURM_ARRAY_TASK_ID
wait
