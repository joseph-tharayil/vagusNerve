...
filename='/gpfs/bbp.cscs.ch/project/proj85/scratch/vagusNerve/Analytic_allActive_squareTerm_slow'
...
srun -n 39 python analytic-Standoff-sideways-highConductivity-slow.py $filename $SLURM_ARRAY_TASK_ID
wait
