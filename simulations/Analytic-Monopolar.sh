...
filename='/gpfs/bbp.cscs.ch/project/proj85/scratch/vagusNerve/results/finalResults/Analytic_monopolar'
...
srun -n 39 python analytic-Standoff-sideways-highConductivity-monopolar.py $filename $SLURM_ARRAY_TASK_ID
wait
