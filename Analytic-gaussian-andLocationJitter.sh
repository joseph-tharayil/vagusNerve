...
filename='/gpfs/bbp.cscs.ch/project/proj85/scratch/vagusNerve/results/finalResults/Analytic_gaussian_andLocationJitter'
...
srun -n 39 python analytic-Standoff-sideways-highConductivity-gaussian-andLocationJitter.py $filename $SLURM_ARRAY_TASK_ID
wait
