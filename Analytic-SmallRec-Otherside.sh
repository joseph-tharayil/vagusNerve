...
filename='/gpfs/bbp.cscs.ch/project/proj85/scratch/vagusNerve/results/finalResults/Analytic_smallRec_otherside'
...
srun -n 39 python analytic-Standoff-sideways-highConductivity-smallRec-otherSide.py $filename $SLURM_ARRAY_TASK_ID
wait
