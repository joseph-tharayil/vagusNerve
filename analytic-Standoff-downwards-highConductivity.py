...
def Recruitment(current,diameters, fascIdx):
    ...
    titrationFactorsUaff = sortTitrationSpace(pd.read_excel('/gpfs/bbp.cscs.ch/project/proj85/scratch/vagusNerve/Data/Titration_Sundt_HighConductivity.xlsx',index_col=0)).iloc[-1].values
    ####
