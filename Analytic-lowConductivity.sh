...
filename='/gpfs/bbp.cscs.ch/project/proj85/scratch/vagusNerve/results/finalResults/Analytic_lowConductivity'
...
srun -n 39 python analytic-Standoff-sideways-lowConductivity.py $filename $SLURM_ARRAY_TASK_ID
wait
