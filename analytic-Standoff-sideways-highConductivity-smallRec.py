...
def FitPhiShape(fascIdx,distance):
    ...
    phi = pd.read_excel('/gpfs/bbp.cscs.ch/project/proj85/scratch/vagusNerve/Data/PhiConductivity_Small_20240213/'+str(fascIdx)+'_BetterConductivity.xlsx')
...
def main(outputfolder,distanceIdx):
    ...
    recordingCurrent = 250e-6 # Current in the S4L recording simulation
