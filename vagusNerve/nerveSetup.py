...
def loadDiameterDistribution(fiberType):
    ...
    if fiberType == 'maff':
        ...
        vals = np.loadtxt(r'D:\vagusOptimizatio\Data\maffvals.csv',delimiter=',')
    elif fiberType == 'meff':

        vals = np.loadtxt(r'D:\vagusOptimizatio\Data\meffvalsSmooth.csv',delimiter=',')

    elif fiberType == 'uaff':
        vals = np.loadtxt(r'D:\vagusOptimizatio\Data\uaffvals.csv',delimiter=',')

    elif fiberType == 'ueff':
        vals = np.loadtxt(r'D:\vagusOptimizatio\Data\ueffvals.csv',delimiter=',')
...
def MeffProb(d, meffProb):
    ...
    meffvals = np.loadtxt(r'D:\vagusOptimizatio\Data\meffvalsSmooth.csv',delimiter=',')

    return meffProb * prob(d,'meff')

def UaffProb(d, uaffProb):

    uaffvals = np.loadtxt(r'D:\vagusOptimizatio\Data\uaffvals.csv',delimiter=',')

    return uaffProb * prob(d,'uaff')

def UeffProb(d, ueffProb):

    ueffvals = np.loadtxt(r'D:\vagusOptimizatio\Data\ueffvals.csv',delimiter=',')
...
def getFasciclePositions():
    ...
    positions = np.load(r'D:\vagusOptimizatio\Data\fiberPositions1950.npy',allow_pickle=True)
